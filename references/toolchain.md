...
2. **Reference PPT pages**: after the image samples are approved, convert those samples into SVG/PPT reference pages and ask the user to review editability, text treatment, chart/table handling, and layout.
...
- Important text should normally be rebuilt as PPT text boxes, using the source text and template typography. Do not rely on traced text outlines when the user needs to edit wording.
